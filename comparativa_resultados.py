...
ax1.plot(H100_1,M_100_1/concentracion_100[0], label=labels_100[0]+ f' - {concentracion_100[0]:.2f} g/L')
ax1.plot(H100_3,M_100_3/concentracion_100[2], label=labels_100[2]+ f' - {concentracion_100[2]:.2f} g/L')
ax1.plot(H100_4,M_100_4/concentracion_100[3], label=labels_100[3]+ f' - {concentracion_100[3]:.2f} g/L')
ax1.plot(H100_2,M_100_2/concentracion_100[1], label=labels_100[1]+ f' - {concentracion_100[1]:.2f} g/L')
axin1 = ax1.inset_axes([0.56, 0.06, 0.42, 0.4],)
axin1.plot(H100_1,M_100_1/concentracion_100[0])
axin1.plot(H100_2,M_100_2/concentracion_100[1])
axin1.plot(H100_3,M_100_3/concentracion_100[2])
axin1.plot(H100_4,M_100_4/concentracion_100[3])
axin1.set_xlim(-60e2,60e2)           
axin1.set_ylim(-10,10)           
...
ax2.plot(H97_1,M_97_1/concentracion_97[0], label=labels_97[0]+ f' - {concentracion_97[0]:.2f} g/L')
ax2.plot(H97_3,M_97_3/concentracion_97[2], label=labels_97[2]+ f' - {concentracion_97[2]:.2f} g/L')
ax2.plot(H97_4,M_97_4/concentracion_97[3], label=labels_97[3]+ f' - {concentracion_97[3]:.2f} g/L')
ax2.plot(H97_2,M_97_2/concentracion_97[1], label=labels_97[1]+ f' - {concentracion_97[1]:.2f} g/L')

axin2 = ax2.inset_axes([0.56, 0.06, 0.42, 0.4])
axin2.plot(H97_1,M_97_1/concentracion_97[0])
axin2.plot(H97_2,M_97_2/concentracion_97[1])
axin2.plot(H97_3,M_97_3/concentracion_97[2])
axin2.plot(H97_4,M_97_4/concentracion_97[3])
...
plt.savefig('comparativa_ciclos_100_97.png',dpi=300)
# %%
